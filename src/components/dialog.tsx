...
export function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      className={cn(
        `fixed inset-0 z-50 bg-background-secondary/60 backdrop-blur-sm data-[state=open]:animate-in data-[state=close]:animate-out data-[state=open]>fade-in-0 data-[state=close]>fade-out-0`,
        className,
      )}
      {...props}
    />
